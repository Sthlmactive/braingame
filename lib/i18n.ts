...
const en = {
  ...
  diffHard: "Hard",
  diffExtreme: "Extreme",
  bandEasyDesc: "Gentle. Most help.",
  bandMediumDesc: "Fewer assists.",
  bandHardDesc: "Little help left.",
  bandExtremeDesc: "Everything turned up.",
...
const sv: Record<StringKey, string> = {
  ...
  diffHard: "Svår",
  diffExtreme: "Extrem",
  bandEasyDesc: "Lugnt. Mest hjälp.",
  bandMediumDesc: "Färre hjälpmedel.",
  bandHardDesc: "Nästan ingen hjälp.",
  bandExtremeDesc: "Allt uppskruvat.",
